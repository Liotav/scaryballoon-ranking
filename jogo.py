...
img_balao = pygame.image.load("static/imagens/balao.png")
...
img_susto = pygame.image.load("static/imagens/susto.png")
...
pygame.mixer.init()
susto_som = pygame.mixer.Sound("static/sons/susto.mp3")
